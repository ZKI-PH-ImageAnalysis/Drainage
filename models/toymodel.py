...
def toymodel4l(num_classes=10):
    return ToyModel(type=MNIST, num_classes=num_classes)

def toymodel8l(num_classes=10):
    return ToyModel(type=CIFAR10, num_classes=num_classes)